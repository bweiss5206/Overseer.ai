...
public class SimpleCollectorAgent : Agent
{
    ...
    public override void OnEpisodeBegin()
    {
        ...
        for (int i = 0; i<25; ++i){
            platform.transform.position = startPosition + Quaternion.Euler(Vector3.up * Random.Range(0f, 360f)) * Vector3.forward * Random.Range(0f, 25f);
            GameObject a = Instantiate(platform);
            a.SetActive(true);
            a.tag = "clone";
        }
